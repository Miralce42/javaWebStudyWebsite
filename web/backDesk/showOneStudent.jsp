...
<head>
    ...
    <script type="text/javascript">
        function updateCheck() {
            ...
            if(name ==="" || phone === "" || major === "" || sex === "" || classNum === ""){
                alert("所有项目都不能为空！");
            }
            else if(sex!=="男" && sex!=="女"){
                alert("性别输入错误！");
...
<div id="fh5co-main" class="right">
    ...
    <div class="panel">
        ...
        <div id="panel-body" class="panel-body">
            ...
            <br>
            学号：<input disabled="disabled" name="user.username" id="username" type="text" class="form-control" value="<%=stu.getUsername()%>">
            <br>
            ...
            <table width="80%">
                <tr>
                    <td align="left"><button class="btn btn-primary" onclick="selectSearch()" type="button">删除</button></td>
                    <td align="left"><button class="btn btn-primary" onclick="updateCheck()" type="button">更改</button></td>
                </tr>
            </table>
        </div>
        </form>
