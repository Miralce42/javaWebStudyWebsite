...
<div style="align-content: center;margin-top: 10%;margin-left: 22%;width: 10%;float:left;" >
    <nav >
        <ul style="font-size: 20px;">
            <li><a href="thePracticeTeaching.jsp?section=实验文件">实验文件</a></li><br/>
            <li><a href="thePracticeTeaching.jsp?section=通知">通知</a></li><br/>
            <li><a href="thePracticeTeaching.jsp?section=其他">其他</a></li><br/>
        </ul>
    </nav>
</div>
</body>
